  ...
  return (
    <AdminModal title={title} onClose={onClose}>
      <div className="flex flex-col gap-4">
        ...
        <div className="border rounded-xl overflow-hidden min-h-75 flex flex-col bg-gray-50/50">
          <div className="p-2 border-b bg-white flex items-center justify-between">
            <span className="text-xs font-bold text-gray-400 uppercase px-2 tracking-wider">
              {currentFolderId === null ? 'Arquivos' : 'Subpastas'}
            </span>
            {currentFolderId !== null && (
              <button
                onClick={handleGoBack}
                className="flex items-center gap-1 text-xs text-blue-600 hover:text-blue-700 font-bold uppercase tracking-wider px-2"
              >
          ...
          <div className="flex-1 overflow-y-auto max-h-100">
            {loading ? (
              ...
              <div className="grid grid-cols-1 divide-y">
                {folders.map((folder) => (
                  <button
                    ...
                    className="flex items-center gap-3 p-3 hover:bg-blue-50 transition text-left group"
                  >
                    <div className="w-10 h-10 rounded-lg bg-white border border-gray-100 flex items-center justify-center text-gray-400 group-hover:text-blue-500 group-hover:border-blue-200 transition-colors shadow-sm">
                      <Folder size={20} />
                    </div>
              ...
              <div className="flex flex-col items-center justify-center h-full gap-2 py-12 px-6 text-center">
                <div className="w-16 h-16 bg-white rounded-2xl border-2 border-dashed border-gray-200 flex items-center justify-center mb-2">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          <Button
            variant="ghost"
            onClick={onClose}
            className="text-gray-500 font-bold uppercase text-[11px] tracking-wider"
          >
            Cancelar
          </Button>
          <Button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-8 font-bold uppercase text-[11px] tracking-wider h-11 shadow-lg shadow-blue-200 disabled:opacity-50 disabled:shadow-none"
          >
