    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full border rounded-xl px-3 py-2.5 text-sm bg-gray-50 dark:bg-zinc-900 dark:text-zinc-100 focus:bg-white dark:focus:bg-zinc-800 focus:outline-none focus:ring-2 transition ${
            error
